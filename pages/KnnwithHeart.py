...
# --- File Uploader and Data Information Section ---
st.subheader("📊 อัปโหลดข้อมูลเพื่อใช้ในการฝึกโมเดล")
st.info("กรุณาอัปโหลดไฟล์ `Health_Risk_Dataset_Encoded.csv`")

# Use st.file_uploader to handle the file upload
...
if uploaded_file is not None:
    ...
    st.warning("กรุณาอัปโหลดไฟล์ข้อมูลเพื่อเริ่มใช้งานแอปพลิเคชัน")